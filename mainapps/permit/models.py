...
class UserGroup(models.Model):
    ...
    users = models.ManyToManyField(settings.AUTH_USER_MODEL,blank=True, related_name='user_groups')
...
class UserRoleAssignment(models.Model):
    ...
    role = models.ForeignKey(UserRole, on_delete=models.CASCADE,related_name='assignments')
